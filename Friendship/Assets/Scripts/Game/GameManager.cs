...
namespace TheBattle
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        public void StartGame()
        {
            ...
            StartCoroutine(IGameStartTimer());
        }
        ...
        IEnumerator IGameStartTimer()
        {
            ...
            while (timer > 0)
            {
                ...
                components.uIManager.DrawTimer(timer); //UI draw
                yield return null;
            }

            //Starter update score for clean
            UpdateScore();
            components.uIManager.StartGame(); //Switch screen to game
